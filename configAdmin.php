    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">MUISIC INSTRUMENT</small></h1>
            </div>
            <!-- Nav tabs -->
				...
				<div class="col-sm-3">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-product">
                            ...
                            <form role="form" id="guardarp" method="post" enctype="multipart/form-data">
                              ...
                              <p class="text-center"><button type="submit" class="btn btn-primary button-GPR">Agregar a la tienda</button></p>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading text-center"><h3>Tabla de productos</h3></div>
                          <div class="table-responsive">
                              <table class="table table-bordered">
                                  <thead class="">
                                      <tr>
                                          <th height="48" class="text-center">Código</th>
                                        ...
                                        while($prod=mysql_fetch_array($productos)){
                                            echo '
                                                <div id="update-product">
                                                  <form method="post" id="res-update-product-'.$upr.'">
                                                    <tr id="ures-update-product-'.$upr.'">
                                                        <td>
                                                      ...
                                                      echo '</select>
                                                       ...
                                                       echo '</select>
														...
														<div class="btn-group" role="group" aria-label="...">
                                                            <button type="submit" class="btn btn-sm btn-primary button-UPR" value="res-update-product-'.$upr.'"><i class="fa fa-refresh"></i></button> 
<button type="submit" class="btn btn-sm btn-danger button-DPR" value="res-update-product-'.$upr.'"><span class="glyphicon glyphicon-trash"></span></button>
															</div>
