...
<input type="text" id="id_dev">
<input type="text" id="id_dev_bkp">
<!--<input type="text" id="txtHint">-->
<p id="sale" style="width:100%; height:auto; text-align:center; display: none">
<button id="chau" type="button" class="greenbtn" style="width:50%" onClick="parent.$.colorbox.close();">
...
<p id="guarda" style="width:100%; height:auto; text-align:center">
<a href="#" onClick="nfy(document.getElementById('id_dev').value,document.getElementById('id_dev_bkp').value);"><button id="nuevo_usuario" type="button" class="bluebtn" style="width:50%">
...
<body style="overflow:hidden">
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <main>
      <div id="notify1" class="push-switch-container js-push-switch-container" style=" border:1px solid #06C">
      ...
      <div class="content-overlap-wrapper" style="display:none">
