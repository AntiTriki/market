...
*/
	...
	var myId = $(this).val();
        $('#update-category form#'+myId).submit(function(e) {
             ...
             var informacion=$('#update-category form#'+myId).serialize();
             var metodo=$('#update-category form#'+myId).attr('method');
             var peticion='process/delcategori.php';
             $.ajax({
                type: metodo,
                url: peticion,
                data:informacion,
	...
	var myId = $(this).val();
        $('#update-product form#'+myId).submit(function(e) {
             ...
             var peticion='process/updateProduct.php';
             $.ajax({
                type: metodo,
                url: peticion,
                data:informacion,
    ...
    $('.button-GPR').click(function() {
	
        $('#guardarp').submit(function(e) {
             e.preventDefault();
             var informacion=$('#guardarp').serialize();
             var metodo=$('#guardarp').attr('method');
             var peticion='process/regprod.php';
...
cache: false,
	...
	var myId = $(this).val();
        ...
        $('#update-product form#'+myId).submit(function(e) {
             ...
             var informacion=$('#update-product form#'+myId).serialize();
             var metodo=$('#update-product form#'+myId).attr('method');
             var peticion='process/delprod.php';
             $.ajax({
                type: metodo,
                url: peticion,
                data:informacion,
