        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">MUSIC INSTRUMENT</small></h1>
                </div>
                       ...
                       <form class="form-horizontal FormCatElec" action="process/regclien.php" role="form" method="post" data-form="save">
                           <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="number" min="0" step="1 placeholder="Ingrese su número de NIT" required name="clien-nit" data-toggle="tooltip" data-placement="top" title="Ingrese su número de NIT. Solamente números " maxlength="11" pattern="[0-9]{8,11}" data-toggle="tooltip" data-placement="top">
                              </div>
                            </div>
                            <br>
                            <div class="form-group">
