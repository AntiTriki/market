                            ...
                            <?php
                                if(!$_SESSION['nombreUser']=="" &&!$_SESSION['claveUser']==""){
									...
									foreach($_POST['prod'] as $key => $text_field){
										echo '<input type="hidden" name="prod[]" value="'.$text_field.'">
	<input type="hidden" name="unidades[]" value="'.$_POST['unidades'][$key].'">';
	}
                                    ...
                                    echo '
                                        ...
                                        <img class="img-responsive center-all-contens" src="assets/img/shopping-cart.png">
										  ...
										  <input type="hidden" name="totas" value="'.$_POST['totas'].'">
                                    ...
                                    echo '
                                        ...
                                        <p>
                                            ...
                                            y contraseña con la cual te registraste en <span class="tittles-pages-logo">MUSIC ELECTRONIC</span>.
                                        </p>
                                        <br>
